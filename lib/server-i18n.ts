const SERVER_TRANSLATIONS = {
  zh: {
    ...
    "scanStages.backendTimeout": "⚠️ 扫描服务响应超时，请重新检测。",
    "scanStages.backendUnavailable": "⚠️ 扫描服务暂时不可用，请稍后重试。",
    "scanStages.demoResultGenerated": "✅ 演示结果已生成",
  ...
  en: {
    ...
    "scanStages.backendTimeout": "⚠️ Scan service timed out. Please scan again.",
    "scanStages.backendUnavailable": "⚠️ Scan service is temporarily unavailable. Please try again.",
    "scanStages.demoResultGenerated": "✅ Demo result generated",
