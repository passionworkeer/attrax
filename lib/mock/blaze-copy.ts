...
export const blazeCopy = {
  zh: {
    ...
    upload: {
      ...
      documents: {
        toggleLabel: "📄 添加产品规格书 / 说明书（可选）",
        toggleHint: "上传 PDF、DOCX、TXT 可让 AI 拿到更完整的产品规格上下文",
        format: "支持 PDF、DOCX、TXT · 单文件 ≤ 15MB · 最多 5 个",
        uploaded: "已添加文档",
        addAnother: "再添加一份",
        invalidType: "文件类型不支持，请上传 PDF、DOCX、TXT",
        tooLarge: "文件超过 15MB，请压缩后重试",
        signatureFailed: "文件格式与扩展名不符，可能已损坏",
        maxCountExceeded: "最多支持上传 5 个文档文件",
        removed: "已移除文档",
      },
    },
    burning: {
  ...
  en: {
    ...
    upload: {
      ...
      documents: {
        toggleLabel: "📄 Add product spec / manual (optional)",
        toggleHint: "Uploading PDF / DOCX / TXT gives the AI richer product specification context",
        format: "PDF, DOCX, or TXT · up to 15MB per file · up to 5 files",
        uploaded: "Attached documents",
        addAnother: "Add another file",
        invalidType: "File type not supported. Use PDF, DOCX, or TXT.",
        tooLarge: "File exceeds 15MB. Please compress and retry.",
        signatureFailed: "File content does not match its extension — may be corrupted",
        maxCountExceeded: "Maximum 5 document files allowed",
