...
export const translations = {
  zh: {
    ...
    result: {
      ...
      degradedBanner: "降级 / 演示数据警告：RAG 服务不可用，以下报告为模板示例数据，不可作为合规决策或进货上架依据。",
      degradedProfitNotice: "成本利润报告同样来自降级示例数据，不可作为定价或预算依据。",
  ...
  en: {
    ...
    result: {
      ...
      degradedBanner: "Degraded / demo data warning: the RAG service is unavailable. The report below is template demo data and MUST NOT be used as a basis for compliance decisions, purchasing, or listing.",
      degradedProfitNotice: "The cost & profit report is likewise degraded demo data and MUST NOT be used for pricing or budgeting.",
