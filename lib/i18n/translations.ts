...
export const translations = {
  zh: {
    ...
    result: {
      ...
      partialFallbackNotice: "本次报告使用了规则+模板兜底生成，LLM 实际未产出引用，请把此报告作为初步风险提示，勿作最终合规结论。",
      invalidNotice: "本次检测数据校验未通过或结果异常损坏，当前结论已被系统判定为不可靠，严禁直接作为上架决策依据。",
      ...
      citations: "法规引用",
      evidencePack: "证据包 PDF",
      noCitations: "本报告未引用具体条款。",
      reupload: "重新上传",
      viewDemo: "查看 Demo",
    ...
    regulations: {
      title: "法规情报中心",
      subtitle:
        "法规库 {archive} 条目录（覆盖 {markets} 个合规区域 / {marketsCovered} 个抓取市场）· {rawFiles} 个抓取原文 · {sources} 个抓取源 · {updates} 条近期动态。",
      demoBadge: "数据快照",
      tabs: {
        archive: "法规档案",
        sources: "抓取源",
      ...
      archive: {
        search: "搜索档案（短名 / 引用 / 编号）...",
        market: "市场",
        allMarkets: "全部市场",
        noResults: "未找到匹配的法规档案",
        citation: "官方引用",
        articles: "条款数",
        source: "原文",
        purchase: "购买",
      ...
      sources: {
        ...
        healthLabels: {
          ok: "可达",
          anti_bot: "反爬保护",
          waf_challenge_temporary: "WAF 临时挑战",
          unreachable: "不可达",
          unknown: "待确认",
        },
      },
  ...
  en: {
    ...
    result: {
      ...
      partialFallbackNotice: "This report was generated from rule + template fallback — the LLM did not actually emit citations. Treat it as an early risk hint, not a final compliance conclusion.",
      invalidNotice: "The scan data failed validation or is corrupted. The conclusions are marked unreliable and must not be used for product launch decisions.",
      ...
      noCitations: "No specific regulation articles cited in this report.",
      reupload: "Re-upload",
      viewDemo: "View Demo",
    ...
    regulations: {
      ...
      subtitle:
        "Archive {archive} entries (covering {markets} compliance regions / {marketsCovered} fetched markets) · {rawFiles} raw files · {sources} ingestion sources · {updates} recent updates.",
      ...
      archive: {
        search: "Search archive (short name / citation / id)...",
        market: "Market",
        allMarkets: "All markets",
        noResults: "No matching regulation found in the archive",
      ...
      sources: {
        search: "Search sources (title / channel / category)...",
        market: "Market",
        health: "Reachability",
        allMarkets: "All markets",
        allHealth: "All",
        noResults: "No matching ingestion source found",
        channel: "Channel",
        fetch: "Fetch path",
        categories: "Categories",
        notes: "Notes",
        openHuman: "Human URL",
        openWatchdog: "Watchdog URL",
        totalLabel: "Sources",
        healthyLabel: "Reachable",
        protectedLabel: "Restricted",
        showing: "Showing 1-{to} of {total}",
        healthLabels: {
          ok: "Reachable",
          anti_bot: "Anti-bot protected",
          waf_challenge_temporary: "WAF challenge (transient)",
