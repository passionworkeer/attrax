...
> **[SUPERSEDED 2026-09-10]** 本文件为一次性项目分析快照，多项待办状态已过期（如
> “删 cohere 死代码 ✗ 未做” —— 实际源码早已不存在并于当日清理依赖）。当前事实以
> `CLAUDE.md` 与 `docs/plans/2026-09-09-optimization-audit.md` 为准，本文件仅作历史参考。
