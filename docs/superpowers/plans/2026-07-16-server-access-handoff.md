...
```bash
ssh -o BatchMode=yes admin@120.77.36.107 "systemctl is-active pm2-root; curl -fsS http://127.0.0.1:3000/api/health"
```
...
**Files:**
- Create: `C:\Users\04735\.codex\memories\extensions\ad_hoc\notes\20260716-attrax-server-access.md`
