# 服务器运维操作手册（aliyun-sz 120.77.36.107）
...
- **SSH 别名**：`aliyun-sz` → `120.77.36.107`（root，banner 提示登录即审计）
