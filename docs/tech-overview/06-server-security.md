...
- **生产机**：aliyun-sz 阿里云深圳 `120.77.36.107`（Ubuntu 24.04.4 LTS），`ufw` allow 22/80/443、deny 3000/3001/8001/8002。
- **nginx vhost**：`wangjianjun.xyz` listen 443；TLS 1.2/1.3；5 个响应安全头；`location ^~ /_next/static/` 用 alias 不走 snippet（Next 16 standalone 不再复制 `.next/static`）。
...
> 生产机：aliyun-sz 阿里云深圳 `120.77.36.107`，Ubuntu 24.04.4 LTS + 内核 6.8。配置文件快照在 `docs/infra/` 与 `docs/SECURITY.md`。
...
- 主 vhost `docs/infra/nginx-attrax-vhost.conf`：
  - `server_name wangjianjun.xyz www.wangjianjun.xyz` listen 443。
...
`RAG_ALLOWED_ORIGINS=https://wangjianjun.xyz,http://localhost:3000`。RAG 8001 只听 loopback，跨域攻击面已收窄到「同站误用」。
...
4 个 jail：`sshd`、`nginx-auth`、`nginx-botsearch`、`recidive`（`/etc/fail2ban/jail.local`）。`fail2ban-client status` 复核一致。`docs/infra/fail2ban-*` 是 lighthouse 时代快照；今天 aliyun-sz 又是新生产，需重新比对——其中残留的 `43.155.141.192` IP 是 1921 旧机记录。
...
- [`docs/SECURITY.md`](file:///Users/wangjianjun/me/attrax/docs/SECURITY.md)：完整安全政策。
- [`docs/infra/README.md`](file:///Users/wangjianjun/me/attrax/docs/infra/README.md)：配置片段清单 + 安装方式。
- [`docs/infra/nginx-attrax-vhost.conf`](file:///Users/wangjianjun/me/attrax/docs/infra/nginx-attrax-vhost.conf)：主 vhost。
- [`docs/infra/nginx-attrax-locations.conf`](file:///Users/wangjianjun/me/attrax/docs/infra/nginx-attrax-locations.conf)：共享 location。
- [`docs/infra/nginx-nginx.conf`](file:///Users/wangjianjun/me/attrax/docs/infra/nginx-nginx.conf)：nginx 主配置（旧机快照，仅参考）。
- [`docs/infra/sshd-00-attrax-hardening.conf`](file:///Users/wangjianjun/me/attrax/docs/infra/sshd-00-attrax-hardening.conf)：sshd 加固。
- [`docs/infra/sysctl-99-attrax-hardening.conf`](file:///Users/wangjianjun/me/attrax/docs/infra/sysctl-99-attrax-hardening.conf)：内核加固。
- [`docs/infra/logrotate-attrax`](file:///Users/wangjianjun/me/attrax/docs/infra/logrotate-attrax)：attrax 自身日志轮转。
- [`docs/infra/cron-attrax-backup`](file:///Users/wangjianjun/me/attrax/docs/infra/cron-attrax-backup) + [`-remote`](file:///Users/wangjianjun/me/attrax/docs/infra/cron-attrax-backup-remote)：备份 cron。
- [`scripts/backup-data.sh`](file:///Users/wangjianjun/me/attrax/scripts/backup-data.sh) + [`backup-remote.sh`](file:///Users/wangjianjun/me/attrax/scripts/backup-remote.sh)：备份脚本。
- [`lib/rate-limit.ts`](file:///Users/wangjianjun/me/attrax/lib/rate-limit.ts)：BFF 限流。
- [`lib/upload-validation.ts`](file:///Users/wangjianjun/me/attrax/lib/upload-validation.ts)：上传校验。
- [`lib/pipeline/session-auth.ts`](file:///Users/wangjianjun/me/attrax/lib/pipeline/session-auth.ts)：会话 token。
