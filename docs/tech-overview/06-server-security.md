...
- **生产机**：lighthouse 腾讯云首尔 `43.155.141.192`，Ubuntu 24.04.4 LTS + 内核 6.8；`ufw` allow 22/80/443、deny 3000/8001。
...
> 生产机：lighthouse 腾讯云首尔 `43.155.141.192`，Ubuntu 24.04.4 LTS + 内核 6.8。配置文件快照在 `docs/infra/` 与 `docs/SECURITY.md`。
