...
每条记录的字段（[示例](file:///Users/wangjianjun/me/attrax/data/regulation_sources/official_sources.json#L1-L32)）：
...
- [`scripts/watchdog/orchestrator.py`](file:///Users/wangjianjun/me/attrax/scripts/watchdog/orchestrator.py)：跑批编排 + 调度循环。
- [`scripts/watchdog/auto_ingest.py`](file:///Users/wangjianjun/me/attrax/scripts/watchdog/auto_ingest.py)：UPDATE / CREATE / MARK / EVIDENCE 四类自动入库。
- [`scripts/watchdog/state.py`](file:///Users/wangjianjun/me/attrax/scripts/watchdog/state.py)：SQLite baseline + 差异检测。
- [`scripts/watchdog/collectors/`](file:///Users/wangjianjun/me/attrax/scripts/watchdog/collectors)：6 个具体采集器。
- [`scripts/watchdog/notify.py`](file:///Users/wangjianjun/me/attrax/scripts/watchdog/notify.py)：webhook 通知（默认 noop）。
- [`data/regulation_sources/official_sources.json`](file:///Users/wangjianjun/me/attrax/data/regulation_sources/official_sources.json)：35 个监控源注册表。
- [`docs/WATCHDOG.md`](file:///Users/wangjianjun/me/attrax/docs/WATCHDOG.md)：运维手册（与本套独立）。
- [`docs/regulations/URL-INVENTORY-2026-09-16.md`](file:///Users/wangjianjun/me/attrax/docs/regulations/URL-INVENTORY-2026-09-16.md)：所有源的人类可访问 URL 总表。
