...
[`docs/infra/NEXTJS-16-STANDALONE-NOTES.md`](file:///Users/wangjianjun/me/attrax/docs/infra/NEXTJS-16-STANDALONE-NOTES.md) 逐条记录：
...
- 多站点 HTTP 探针（`wangjianjun.xyz` / `/api/health`）。
- pm2 进程内存 / 状态。
...
- [`scripts/build-deploy-tarball.sh`](file:///Users/wangjianjun/me/attrax/scripts/build-deploy-tarball.sh)：本地构建 tarball。
- [`scripts/apply-deploy.sh`](file:///Users/wangjianjun/me/attrax/scripts/apply-deploy.sh)：服务器解包（保留 2 份回滚）。
- [`scripts/ecosystem.config.cjs`](file:///Users/wangjianjun/me/attrax/scripts/ecosystem.config.cjs)：pm2 配置。
- [`scripts/guard-no-server-build.mjs`](file:///Users/wangjianjun/me/attrax/scripts/guard-no-server-build.mjs)：服务器构建守卫。
- [`scripts/preflight-deploy.mjs`](file:///Users/wangjianjun/me/attrax/scripts/preflight-deploy.mjs)：部署前自检。
- [`scripts/backup-data.sh`](file:///Users/wangjianjun/me/attrax/scripts/backup-data.sh)：本地 14 份备份。
- [`scripts/backup-remote.sh`](file:///Users/wangjianjun/me/attrax/scripts/backup-remote.sh)：异地备份（no-op）。
- [`docs/infra/NEXTJS-16-STANDALONE-NOTES.md`](file:///Users/wangjianjun/me/attrax/docs/infra/NEXTJS-16-STANDALONE-NOTES.md)：Next 16 standalone 部署坑总览。
...
- [`docs/infra/logrotate-attrax`](file:///Users/wangjianjun/me/attrax/docs/infra/logrotate-attrax)：日志轮转。
- [`CHANGELOG.md`](file:///Users/wangjianjun/me/attrax/CHANGELOG.md)：历史事故 + 修复时间线。
- [`CLAUDE.md §部署雷区`](file:///Users/wangjianjun/me/attrax/CLAUDE.md)：常见踩坑清单（构建雷区、pm2 env、nginx alias、openrsync、服务器 git 落后）。