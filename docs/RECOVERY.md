# Recovery Procedure — 203.0.113.10
...
```bash
ssh -o ConnectTimeout=15 root@203.0.113.10 'uptime; free -m'
```
...
1. https://ecs.console.aliyun.com → Instances → `iZinstance0000001` (or by IP 203.0.113.10)
