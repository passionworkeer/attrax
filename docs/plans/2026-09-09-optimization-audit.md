...
- **位置**:
  - `/Users/wangjianjun/me/attrax/lib/pipeline/scan.ts`
  - `/Users/wangjianjun/me/attrax/lib/pipeline/scan-queue.ts`
...
- **位置**: `/Users/wangjianjun/me/attrax/components/upload/UploadForm.tsx` (509 行)
- **现状**:
...
- **位置**:
  - `/Users/wangjianjun/me/attrax/components/result/LegacyResultView.tsx` (90 行)
  - `/Users/wangjianjun/me/attrax/components/result/DegradedBanner.tsx`
  - `/Users/wangjianjun/me/attrax/components/result/SourceNotice.tsx`
- **现状**:
...
- **位置**: `/Users/wangjianjun/me/attrax/lib/pipeline/upload-storage.ts`
- **现状**:
...
- **位置**: `/Users/wangjianjun/me/attrax/package.json`
...
- **位置**:
  - `/Users/wangjianjun/me/attrax/rag_service/requirements.txt` (563 行)
...
- **位置**: `/Users/wangjianjun/me/attrax/app/api/regulations/updates/data.ts` (1020 行)
...
- **位置**: `/Users/wangjianjun/me/attrax/rag_service/orchestrator/nodes/generator.py:225`
- **现状**:
...
- **位置**: `/Users/wangjianjun/me/attrax/lib/pipeline/session-store.ts:185-203` (`persistSession`)；调用方 `/Users/wangjianjun/me/attrax/lib/pipeline/scan.ts:160, 166, 172, 252, 256, 277, 283, 451`
- **现状**:
...
- **位置**: `/Users/wangjianjun/me/attrax/app/result/[sessionId]/page.tsx` (1200 行, "use client")
- **现状**:
...
- **位置**: `/Users/wangjianjun/me/attrax/lib/i18n/translations.ts`
...
- **位置**: `/Users/wangjianjun/me/attrax/rag_service/application/scans.py:527-621`
...
- **位置**: `/Users/wangjianjun/me/attrax/lib/pipeline/session-auth.ts:21-30`
- **现状**: 仅 `Bearer` header；查询字符串 token 显式禁止。`tests/unit/session-auth.test.ts` 有回归测试。已合规

### 3.3 [新发现·中] `rag_service/api/v1.py` 路径白名单缺失
- **位置**: `/Users/wangjianjun/me/attrax/rag_service/api/v1.py:39-54`
- **现状**:
...
- **位置**: `/Users/wangjianjun/me/attrax/app/api/scan/route.ts:218-220`
- **现状**:
...
- **位置**: `/Users/wangjianjun/me/attrax/lib/rate-limit.ts:58-61`
- **现状**: 默认 `false`，多维指纹降级到 UA+accept-language+accept-encoding 哈希。已合规

### 3.6 [新发现·低] CORS 白名单默认值仅 localhost
- **位置**: `/Users/wangjianjun/me/attrax/rag_service/config.py:64-69`
...
- **位置**: `/Users/wangjianjun/me/attrax/middleware.ts:23-24`
- **现状**:
...
- **位置**: `/Users/wangjianjun/me/attrax/app/api/scan/route.ts:111-112`
- **现状**:
...
- **位置**: `/Users/wangjianjun/me/attrax/lib/pipeline/scan.ts:252-265`
- **现状**:
...
### 4.1 [现状·低] 端到端覆盖相对充分
- **位置**:
  - `/Users/wangjianjun/me/attrax/tests/unit/` (67 个测试文件)
...
- **位置**:
  - `/Users/wangjianjun/me/attrax/lib/report-export-modules/compliance.ts`
  - `decision.ts`
  - `roadmap.ts`
- **现状**:
...
- **位置**:
  - `/Users/wangjianjun/me/attrax/lib/pipeline/profit-report.ts` (813 行)
  - `report-package.ts`
- **现状**:
...
- **位置**: `/Users/wangjianjun/me/attrax/lib/upload-validation.ts`
...
- **位置**: `/Users/wangjianjun/me/attrax/rag_service/api/v1.py:36-38`
- **现状**:
...
- **位置**: `/Users/wangjianjun/me/attrax/tests/unit/scan-queue.test.ts`
- **现状**: 467 行的 dead code 有完整测试
- **建议**: 跟随 1.1 删除

### 4.7 [新发现·低] 压力测试仅 smoke/load 两档
- **位置**: `/Users/wangjianjun/me/attrax/tests/pressure/` (3 个脚本)
...
- **位置**: `/Users/wangjianjun/me/attrax/PROJECT_ANALYSIS.md`
- **现状**:
...
- **位置**: `/Users/wangjianjun/me/attrax/scripts/deploy.sh` (85 B), `scripts/deploy.ps1` (111 B), `scripts/deploy-now.sh` (3470 B)
...
- **位置**: `/Users/wangjianjun/me/attrax/package-lock.json` (548580 B, ~7200 行)
