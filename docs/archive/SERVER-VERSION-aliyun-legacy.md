...
> ⚠️ **SUPERSEDED — 2026-08-13 历史快照**。本文档仅适用已退役的阿里云深圳服务器 `203.0.113.10`。attrax 当前生产已迁至腾讯云首尔 lighthouse（`198.51.100.20`）；`.deployed` 治本机制对 lighthouse 同样适用，对账方式见根目录 [`CLAUDE.md`](../CLAUDE.md) §部署雷区 与 [`docs/README.md`](./README.md) §生产部署。
