...
Combines: Dense (Cohere) + BM25 -> RRF Fusion -> Must Check -> Rerank
"""
import logging
...
class HybridRetriever:
    ...
    Usage:
        retriever = HybridRetriever(embedder=embedder, bm25=bm25, qdrant_client=qc)
    ...
    def load_chunks(self, chunks: list[dict]):
        """Load chunks into both BM25 index and prepare for Qdrant."""
        if self.bm25:
