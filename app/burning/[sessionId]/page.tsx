...
export default function BurningPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-blaze-dark px-6 py-16 text-white">
      <section className="w-full max-w-2xl rounded-4xl border border-white/10 bg-white/6 p-8 shadow-[0_20px_80px_rgba(0,0,0,0.35)] backdrop-blur">
