...
const TEST_CASES: TestCase[] = [
  {
    ...
    targetMarketName: "欧盟",
    targetMarketCode: "EU",
    dirPath: "/workspace/me/attrax/规航AI-三产品完整测试包-20260914/01-Anker-A2332-充电器-EU",
    images: [
      "01-正反面整体.jpg",
      "02-铭牌标签近照.jpg",
      "03-接口与插脚.jpg",
  ...
  },
  {
    ...
    targetMarketName: "欧盟",
    targetMarketCode: "EU",
    dirPath: "/workspace/me/attrax/规航AI-三产品完整测试包-20260914/02-Xiaomi-Smart-Kettle-2-Pro-EU",
    images: [
      "01-整机整体照.jpg",
      "02-铭牌与合规标志近照.jpg",
      "03-包装与参数.jpg",
  ...
  },
  {
    ...
    targetMarketName: "美国",
    targetMarketCode: "US",
    dirPath: "/workspace/me/attrax/规航AI-三产品完整测试包-20260914/03-LEGO-76429-玩具-US",
    images: [
      "01-产品整体照.jpg",
      "02-包装与年龄警告.jpg",
      "03-附件与主体分开展示.jpg",
...
const ARTIFACT_DIR = "/workspace/.gemini/antigravity/brain/22f2f1a8-7e7f-4f5d-b09f-07188ee03d32/screenshots";
const REPO_SCREENSHOT_DIR = "/workspace/me/attrax/.screenshots/regression-20260915";
...
async function runSingleCase(browser: any, testCase: TestCase, caseIndex: number) {
  ...
  try {
    ...
    await page.goto("https://example.com/upload", { waitUntil: "networkidle" });
    ...
    const apiUrl = `https://example.com/api/scan/${sessionId}`;
    ...
    await page.goto(`https://example.com/profit/${sessionId}`, { waitUntil: "networkidle" });
...
async function main() {
  ...
  console.log("Target Server: https://example.com");
